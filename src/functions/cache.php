 ...
 */
function get_size_cache_object()
{
    global $wp_object_cache;
 ...
 *
 * @param  bool $size The desired size.
 *
 * @return void
 */
function reset_cache_wpdb($size)
{
    global $wpdb;
 ...
 * @return void
 */
function reset_cache_object($size)
{
    global $wp_object_cache;
